...
const Bigcmt = () => {
  ...
  const items = [
    ...
    { imgSrc: '../img/unodc.jpg', title: 'UNODC', content: "Established in 1997, the United Nations Office on Drugs and Crime (UNODC) spearheads the global battle against illicit drugs, international crime, and terrorism. With around 500 staff members globally, UNODC focuses on raising awareness about drug abuse dangers, enhancing international efforts against illicit drug activities, and combating drug-related crime. Initiatives include alternatives to illicit drug cultivation, crop monitoring, and anti-money laundering projects. Join the 10th Jadavpur University Model UN Conference to strategize against organized crime and drug trafficking. UNODC's online committee, suitable for beginners, aims to create a robust deterrence framework for a safer world." },
    { imgSrc: '../img/unicef.jpg', title: 'UNICEF', content: "Established in 1946 post-World War II, UNICEF prioritizes aiding at-risk children globally. Operating in 190+ countries, it ensures children's survival, development, and rights protection. As the largest vaccine provider, UNICEF addresses health, nutrition, water, sanitation, education, HIV prevention, and child protection. It responds to emergencies, providing essential aid. Join the 10th Jadavpur University Model UN Conference for unbiased discussions on defending children's rights. UNICEF's online committee welcomes beginner-level double delegates." },
