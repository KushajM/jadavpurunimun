      ...
      <div className="we-are-block">
        <div id="about-us-section">
          ...
          <div className="about-us-info">
            ...
            <br />
            <br />
            With a legacy this strong, we as a team only aim to expand our ambit further by extending the conversation to people in this country and abroad. We understand our role and responsibility in addressing the real issues that lie outside committee rooms and we only aim to extend this in our 10th edition by aspiring to diversify our dialogue and endeavour.
            </p>
